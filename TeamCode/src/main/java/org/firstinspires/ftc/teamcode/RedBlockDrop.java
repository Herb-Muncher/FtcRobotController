...
@Autonomous(name = "RedBlockDrop", group = "FreightFrenzy")

public class RedBlockDrop extends LinearOpMode {
    private BNO055IMU.Parameters params = new BNO055IMU.Parameters();

    private RedDelivery delivery = new RedDelivery();
    ...
    public void initialize(){ // initializes all of the motors and sets the ZeroPowerBehavior to BRAKE
        ...
        delivery = new RedDelivery(sensorN, sensorW, sensorE, sensorS, imu, leftLow, leftUp, rightLow, rightUp, arm, actuate, spin, claw1, claw2);
    ...
    private void initVuforia() {
        ...
        webcam = hardwareMap.get(WebcamName.class, "Webcam 2");
