...
@Autonomous(name = "BlueDuckPark", group = "FreightFrenzy")
...
public class BlueDuckPark extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        while(opModeIsActive()){
            ...
            point.rotate(87, "s","S", .4);
            //point.moveStraight(50.0, "backward", 0.4);
            while(sensorS.getDistance(DistanceUnit.MM) >= 300){
                motorPower = 0.3;
            ...
            //point.rotate(90, "s","S");
            point.moveSideways(500.0,"right",0.5);
            point.moveStraight(125.0, "backward", 0.5);
