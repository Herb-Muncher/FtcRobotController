...
@Autonomous(name = "AutoThree", group = "GameChangers")


public class AutoThree extends AutonomousCode {
    ...
    public void runOpMode() throws InterruptedException {
       ...
       /* rightLowerMotor.setPower(1.0);
        ...
        if(zone.equals("A")){
            ...
            // pick up wobble
            move.spin(leftLowerMotor,leftUpperMotor,rightLowerMotor,rightUpperMotor,2100,power,1,true);
            move.strafe(leftLowerMotor, leftUpperMotor, rightLowerMotor, rightUpperMotor, 100, power, -1, true); // if multiplier is negative, right: true moves left
            wobbleGrabber.setPosition(1.0);
            move.moveForward(leftLowerMotor, leftUpperMotor, rightLowerMotor, rightUpperMotor, 1200, power, -1);
            wobbleGrabber.setPosition(0.0);
            sleep(500);
            ...
            move.spin(leftLowerMotor,leftUpperMotor,rightLowerMotor,rightUpperMotor,2000,power,1,false);
            move.strafe(leftLowerMotor, leftUpperMotor, rightLowerMotor, rightUpperMotor, 200, power, -1, true); // if multiplier is negative, right: true moves left
            ...
            sleep(1000);*/
            rightLowerMotor.setPower(0.0);
            move.moveForward(leftLowerMotor, leftUpperMotor, rightLowerMotor, rightUpperMotor, 3000, power, -1);
            move.strafe(leftLowerMotor,leftUpperMotor,rightLowerMotor,rightUpperMotor,350,power,-1, true);
            wobbleGrabber.setPosition(1.0);
            sleep(200);
            arm.setPower(1.0);
            sleep(500);
            ...
            arm.setPower(0.0);
            sleep(100);
            move.moveForward(leftLowerMotor, leftUpperMotor, rightLowerMotor, rightUpperMotor, 600, power, -1);
            wobbleGrabber.setPosition(0.0);
            sleep(700);
            arm.setPower(1.0);
            sleep(500);
            ...
            // moves to zone C
            move.spin(leftLowerMotor,leftUpperMotor,rightLowerMotor,rightUpperMotor,900,power,1,true);
            move.strafe(leftLowerMotor,leftUpperMotor,rightLowerMotor,rightUpperMotor,700,power,-1, true);
            move.moveForward(leftLowerMotor,leftUpperMotor,rightLowerMotor,rightUpperMotor,4000,power,-1);
            move.strafe(leftLowerMotor,leftUpperMotor,rightLowerMotor,rightUpperMotor,500,power,-1, true); // strafe at the end, makes sure we are in the box
